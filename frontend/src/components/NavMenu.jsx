...
function NavMenu({isAuthorized}) {
    ...
    return (
        <>
            <div className="flex flex-row py-2 px-4 font-sans mx-auto mb-2">
                <a 
                    className="text-3xl md:text-5xl text-cyan-300 font-bold float-left mr-6 md:mr-12 cursor-pointer"
                    href="/"
                >
                    XdBooru
                </a>
                <nav className="text-lg md:text-2xl md:gap-2 flex justify-between w-full mr-6">
                    ...
                    <div className="w-1/3">
                        {
                            isAuthorized ? 
                                <div className="flex flex-row group cursor-pointer justify-end">
                                    <svg 
                                    ...
                                    <a 
                                        href="/user/profile/" 
                                        className="p-1 md:p-2 text-gray-400 group-hover:text-gray-500 overflow-clip"
                                    >
